...
The template names you have available are defined below.  Once you put these in your 
...
${row_index} value.  Here we set it to 1, sto start with row 1.  If your attack fails at row n, you can 
edit this value to resume your attack.  

""" + bcolors.BOLD + """${char_index:1}""" + bcolors.ENDC + """ = This tells bbqsql which character from the 
subselect to query.  Here we start with position 1 of the subselect.  You should always set this to a value of 1
...
from the subselect to validate the result.  Set this to 0 and the search algorithm will do the rest.  
